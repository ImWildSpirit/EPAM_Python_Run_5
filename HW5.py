...
class News():
    ...
    #  Initialization module. If needed to upload to another file, file name can be specified on initializing. Example: News('Filename.txt')
    ...
    def __set_text(self):
        try:
            #  self.__class__.__name__ construction allows user to see which class was initialized at this moment. Useful in inharited classes
...
class PrivateAd(News):
    ...
    #  Initialization module. If needed to upload to another file, file name can be specified on initializing. Example: PrivateAd('Filename.txt')
    def __init__(self, file_name = 'Publication.txt'):
        self.file_name = file_name
    ...
    def get_days_till_expire(self):
        ...
        result = self.exp_date - today  #  Dates substraction
    ...
    def publish(self):
        ...
        self.expire_count = self.get_days_till_expire()  #  After that amount of days till expiration will be calculated automatically
...
class Review(News):
    ...
    #  Initialization module. If needed to upload to another file, file name can be specified on initializing. Example: Review('Filename.txt')
    def __init__(self, file_name = 'Publication.txt'):
        self.file_name = file_name
        super().__init__(self.file_name)  #  Calls the parent class initialization module
